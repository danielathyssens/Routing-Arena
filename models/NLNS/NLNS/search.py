...
from models.NLNS.NLNS import search_single, search_batch
from models.NLNS.NLNS.vrp.data_utils import read_instances_pkl
import glob
# from . import search_batch
...
def load_operator_pairs(path, config):
    if path.endswith('.pt'):
        model_paths = [path]
        #print(f'model_path: {model_paths}')
    else:
    ...
    for model_path in model_paths:
        ...
        # print(f'operator_pair: {operator_pair.model[-1], operator_pair.destroy_procedure[-1], operator_pair.p_destruction}')
