...
class VRPInstance():
    def __init__(self, nb_customers, locations, original_locations, demand, capacity, id_=None, use_cost_memory=True):
        self.instance_id = id_
        ...
        self.solution = None  # List
        # of tours. Each tour is a list of location elements. Each location element is a
    ...
    def create_initial_solution(self):
        ...
        mask = np.array([True] * (self.nb_customers+ 1)) #+ 1
        mask[0] = False
        while mask.any():
