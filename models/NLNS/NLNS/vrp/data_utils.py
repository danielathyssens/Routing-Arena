...
def get_blueprint(blueprint_name):
    ...
    if type == "ALTR":
        import models.NLNS.NLNS.vrp.dataset_blueprints.ALTR
        return models.NLNS.NLNS.vrp.dataset_blueprints.ALTR.dataset[instance]
    elif type == "XE":
        import models.NLNS.NLNS.vrp.dataset_blueprints.XE
        return models.NLNS.NLNS.vrp.dataset_blueprints.XE.dataset[instance]
    elif type == "S":
