...
class CVRPEnv:
    ...
    def use_benchmark_problems(self, data_instances: List[CVRPInstance], device=None):
        ...
        self.saved_depot_xy, self.saved_node_xy, self.saved_node_demand = make_pomo_instances(data_instances, device)
...
def make_pomo_instances(data: List[CVRPInstance], device=None):
