...
def load_problem(name):
    from models.AM.AM.problems import TSP, CVRP, SDVRP, OP, PCTSPDet, PCTSPStoch
    problem = {
        'tsp': TSP,
        'cvrp': CVRP,
        'sdvrp': SDVRP,
...
def load_model(path, epoch=None, device=None, is_eval=False, opts=None):
    print(os.getcwd())
    # from models.AM.nets.attention_model import AttentionModel
    from models.AM.attention_model import AttentionModel
    from models.AM.nets.pointer_network import PointerNetwork
    #models.AM
    #models.
