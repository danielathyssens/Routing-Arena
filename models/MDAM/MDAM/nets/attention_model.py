...
from models.MDAM.MDAM.nets.graph_encoder import GraphAttentionEncoder
from models.MDAM.MDAM.utils.beam_search import CachedLookup
from models.MDAM.MDAM.utils.functions import sample_many
from models.MDAM.MDAM.utils.tensor_functions import compute_in_batches
...
class AttentionModel(nn.Module):
    ...
    def forward(self, input, opts=None, baseline=None, bl_val=None, n_EG=None, return_pi=False, return_kl=False):
        ...
        # first step
        # print('self.n_paths', self.n_paths)
        ...
        if self.n_paths > 1 and baseline != None:
            ...
            # print('loss_kl_divergence', loss_kl_divergence)
