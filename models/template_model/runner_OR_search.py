...
from models.template_model.template_model_OR import eval_OR_method
from models.runner_utils import _adjust_time_limit, print_summary_stats, eval_inference, set_passMark, \
    set_device, get_time_limit, NORMED_BENCHMARKS
...
class Runner:
    ...
    def _build_policy(self):
        ...
        # executable to be called - self.policy set to None
        self.policy = None
    ...
    def run_inference(self):
        ...
        _, solutions_ = eval_OR_method(data=self.ds.data,
