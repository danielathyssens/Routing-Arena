####
# This code file is amended from the original code provided in
...
# changes: added 107-108 (retrieving tsp solution)
...
class TSP(object):
    ...
    def step(self, batch, rec, exchange, pre_bsf, solving_state = None, best_solution = None):
        ...
        return next_state, reward, torch.cat((new_obj[:,Ndone], now_bsf[:,None]),-1), solving_state, sol
