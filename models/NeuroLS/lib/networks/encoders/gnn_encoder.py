...
from models.NeuroLS.lib.networks.encoders.graph_conv import GraphConvBlock
from models.NeuroLS.lib.networks.encoders.eg_graph_conv import EGGConv
from models.NeuroLS.lib.networks.encoders.base_encoder import BaseEncoder
from models.NeuroLS.lib.networks.formats import GraphObs, Emb
...
def _test(
    ...
    import sys
    from models.NeuroLS.lib.env.utils import GraphNeighborhoodSampler
